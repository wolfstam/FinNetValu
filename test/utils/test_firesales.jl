...
a = zeros(size(fsmodel.C_ϵ))
x = FinNetValu.init(fsmodel, a)
y = deepcopy(x)
a4 = zeros(size(fsmodel4.C_ϵ))
x4 = FinNetValu.init(fsmodel4, a4)
y4 = deepcopy(x4)
a5 = zeros(size(fsmodel5.C_ϵ))
x5 = FinNetValu.init(fsmodel5, a5)
a6 = zeros(size(fsmodel5.C_ϵ))
x6 = FinNetValu.init(fsmodel6, a6)
y6 = deepcopy(x6)
a7 = zeros(size(fsmodel7.C_ϵ))
x7 = FinNetValu.init(fsmodel7, a7)
y7 = deepcopy(x7)
